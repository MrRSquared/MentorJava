...
import frc.robot.UnitConversion.Angle;
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    myField.setRobotPose(5.0,5.0,rotation.fromDegrees(0.0));
  ...
  public void teleopPeriodic() {
    ...
    angle.setInputNumber(m_stick.getX());
    angle.convert();
    SmartDashboard.putNumber("Angle", angle.getOutputNumber());
    
    myField.setRobotPose(m_stick.getY(),0.0,rotation.fromDegrees(angle.getOutputNumber()));
  }
